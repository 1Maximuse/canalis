...
public class SceneMainMenu extends Scene {
	...
	public SceneMainMenu(Game game, Display display) {
		...
		addSceneObject(new ButtonChangeScene(display, (display.getWidth()/2)-(200/2) - 150, (display.getHeight()/2)+50, 200, 80, 1, Assets.buttonPlayCasual));
		addSceneObject(new ButtonChangeScene(display, (display.getWidth()/2)-(200/2) + 150, (display.getHeight()/2)+50, 200, 80, 4, Assets.buttonPlayTimeAttack));
